...
public class DashboardController {
    ...
    @FXML private Button btnAfficherConsultation;
    ...
    public void initialize() {
        ...
        btnAjouterConsultation.setOnAction(e ->
                loadView("/views/Consultation.fxml"));

        btnAfficherConsultation.setOnAction(e ->
                loadView("/views/ConsultationTable.fxml"));
    }
