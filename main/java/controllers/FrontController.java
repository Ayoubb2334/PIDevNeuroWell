...
public class FrontController implements Initializable {
    ...
    @FXML private Button btnEspacePsy;      // espace psychologue
    ...
    private void setupConsultationButtons() {
        ...
        if (btnConsultation != null) {
            ...
            boolean isPsy   = SessionManager.isPsy();
        ...
        if (btnEspacePsy != null) {
            ...
            boolean isPsy = SessionManager.getCurrentUser() != null
                    && "psy".equals(SessionManager.getCurrentUser().role);
    ...
    /** Navigate to the Paiement front page */
    @FXML
    private void handlePaiement(ActionEvent event) {
        navigateTo(event, "/views/PaiementFront.fxml");
    }
